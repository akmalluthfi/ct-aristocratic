...
<body>
    ...
    <div class="bg-white shadow rounded p-1 content">
        <div class="text-center">
            <img src="http://localhost{$Link}/images/email/mail.png" class="big-icon">
        </div>
        <!-- <h2 class="text-center">Halo Admin</h2> -->
        <h2 class="text-center">a new post</h2>
        <h3 class="heading text-center">Hey, we have a new post with title <span class="text-bold text-italic">"$Title"</span>, and written by <span class="text-bold">$Writer</span>
        </h3>
        <div class="w-100 text-center mt-2">
            <a href="http://localhost{$PostLink}" class="btn-reply">See the post</a>
        </div>
    ...
    <footer class="mt-2">
        ...
        <p class="text-center">you can <a href="http://localhost{$Link}/blog/unSubs?id={$ID}">unsubscribe</a> here</p>
