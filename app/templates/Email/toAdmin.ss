...
<head>
    ...
    <style>
        ...
        .big-icon {
            width: 100px;
            filter: invert(9%) sepia(36%) saturate(7382%) hue-rotate(179deg) brightness(98%) contrast(102%);
        }
...
<body style="backgorund-color:whitesmoke;">
    <!-- Header -->
    <header class="">
        <h1 class="color-green">$SiteConfig.Title</h1>
    </header>

    <!-- Content -->
    <div class="bg-white shadow rounded p-1 content">
        <div class="text-center">
            <img src="http://localhost{$Link}/images/email/envelope-open-text-solid.svg" class="big-icon">
        </div>
        <!-- <h2 class="text-center">Halo Admin</h2> -->
        <h2 class="text-center">Halo Admin, You got Message From $Name</h2>
        <h3 class="heading">Here details for you : </h3>
        <ul>
            <li>Name : $Name</li>
            <li>Phone : $Phone</li>
            <li>Email : $Email</li>
            <li>Message :
                <p style="line-height: 1.2rem;margin-top: 10px;">$Message</p>
            </li>
        </ul>
