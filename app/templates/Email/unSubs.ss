...
<body>
    ...
    <div class="bg-white shadow rounded p-1 content">
        <div class="text-center">
            <img src="http://localhost{$Link}/images/email/sad.png" class="big-icon">
        </div>
        <h2 class="text-center">Unsubscribe</h2>
        <h3 class="heading text-center">This $Email have been removed from this subscriber list and won't receive any further emails from us.</h3>
        <p style="font-weight: 700;margin-bottom: 1rem;font-size: 16px">Have a question?</p>
        <p style="font-size: 16px">Did you unsubscribe by accident? <a href="http://localhost{$Link}/blog">re-subscribe</a></p>
    </div>
